...
import hr.tvz.videc.vaxapp.controller.VaccineController;
...
//                new VaccineServ(new JdbcVaccineRepository(new JdbcTemplate())));
//        vaccineController.addVaccine(new VaccineCommand("Research Name", "Manufacturer Name", "Type", 10, 1L));
//    }
